...
-- Insert into plan_version
INSERT INTO plan_version(uuid, plan_id, version, countersigning_status, agreement_status, created_date, created_by_id, last_updated_date, last_updated_by_id, read_only)
SELECT '9f2aaa46-e544-4bcd-8db6-fbe7842ddb64', plan.id, 0, 'UNSIGNED', 'DRAFT', now(), practitioner.id, now(), practitioner.id, false
