INSERT INTO goal (uuid, title, area_of_need_uuid, target_date, creation_date, goal_order, plan_id)
SELECT 'ede47f7f-8431-4ff9-80ec-2dd3a8db3841', 'Goal Title', aon.uuid, '2024-06-27 16:10:57.299363',
...
SELECT step.id, 'Delete name', 1 FROM step;
